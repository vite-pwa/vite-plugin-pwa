...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { property: 'og:image', content: 'https://deploy-preview-315--vite-plugin-pwa.netlify.app//og-image.png' }],
    ['meta', { property: 'twitter:title', content: 'Vite Plugin PWA' }],
    ['meta', { property: 'twitter:card', content: 'summary_large_image' }],
    ['meta', { property: 'twitter:image', content: 'https://deploy-preview-315--vite-plugin-pwa.netlify.app//og-image.png' }],
    ['meta', { property: 'twitter:site', content: '@antfu7' }],
