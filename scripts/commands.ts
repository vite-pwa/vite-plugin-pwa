export const commands = [
  ...
  'npx tsup src/client/build/preact.ts --external preact --format esm -d dist/client/build',
  ...
  'npx tsup src/client/dev/preact.ts --external preact --format esm -d dist/client/dev',
